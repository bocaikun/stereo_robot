    ...
    for e in range(epoch):
        ...
        for train_left, train_right, train_position in train_dataloader:
            ...
            for steps in range(49+3):
                ...
                t_pred_left, t_pred_right, t_train_position, att_map1, att_map2, train_rnn_hidden = model(t_train_left, t_train_right, t_train_position, train_rnn_hidden)
                ...
                with torch.no_grad():
                    for test_left, test_right, test_position in test_dataloader:
                        ...
                        for steps in range(49+3):
                            ...
                            t_pred_left, t_pred_right, t_test_position, t_test_attmap1, t_test_attmap2, test_rnn_hidden = model(t_test_left, t_test_right, t_test_position, test_rnn_hidden)
