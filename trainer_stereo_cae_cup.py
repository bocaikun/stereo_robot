...
def main(
    ...
    model = stereo_cae_att(img_fusion_dim=24,pos_fusion_dim=12)
    ...
    for e in range(epoch):
        ...
        for train_left, train_right, train_position in train_dataloader:
            model.train()
            train_loss, train_position_loss, train_left_loss, train_right_loss = 0., 0., 0., 0.
            ...
            for steps in range(49+3):
                ...
                t_pred_left, t_pred_right, t_train_position, train_rnn_hidden = model(t_train_left, t_train_right, t_train_position, train_rnn_hidden)
            ...
            train_loss = train_position_loss + train_left_loss + train_right_loss
            optimizer.zero_grad()
            train_loss.backward()
            optimizer.step()
                ...
                with torch.no_grad():
                    for test_left, test_right, test_position in test_dataloader:
                        ...
                        for steps in range(49+3):
                            ...
                            t_pred_left, t_pred_right, t_test_position, test_rnn_hidden = model(t_test_left, t_test_right, t_test_position, test_rnn_hidden)
